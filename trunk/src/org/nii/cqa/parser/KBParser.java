...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Jul 13 15:55:59 JST 2011
  */
public class KBParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\026\000\002\011\003\000\002\002\004\000\002\011" +
    ...
    "\004\000\002\004\004\000\002\003\005\000\002\002\003" +
    "\000\002\002\003\000\002\002\005\000\002\002\005" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\046\000\006\006\006\014\013\001\002\000\014\002" +
    "\001\005\031\011\045\012\001\013\044\001\002\000\006" +
    "\002\037\012\040\001\002\000\004\014\013\001\002\000" +
    "\006\002\ufffe\012\ufffe\001\002\000\010\002\uffff\011\034" +
    "\012\uffff\001\002\000\006\005\025\013\026\001\002\000" +
    "\014\002\ufff3\005\ufff3\011\ufff3\012\ufff3\013\ufff3\001\002" +
    "\000\004\007\014\001\002\000\006\014\017\015\020\001" +
    "\002\000\014\002\ufff1\005\ufff1\011\ufff1\012\ufff1\013\ufff1" +
    "\001\002\000\006\004\021\010\022\001\002\000\006\004" +
    "\uffef\010\uffef\001\002\000\006\004\uffee\010\uffee\001\002" +
    "\000\006\014\023\015\024\001\002\000\014\002\ufff0\005" +
    "\ufff0\011\ufff0\012\ufff0\013\ufff0\001\002\000\006\004\uffed" +
    "\010\uffed\001\002\000\006\004\uffec\010\uffec\001\002\000" +
    "\006\006\006\014\013\001\002\000\006\006\006\014\013" +
    "\001\002\000\010\002\ufff6\005\031\012\ufff6\001\002\000" +
    "\010\002\ufff8\005\025\012\ufff8\001\002\000\006\006\006" +
    "\014\013\001\002\000\012\002\ufff5\005\ufff5\012\ufff5\013" +
    "\ufff5\001\002\000\012\002\ufff4\005\ufff4\012\ufff4\013\ufff4" +
    "\001\002\000\006\006\006\014\013\001\002\000\010\002" +
    "\ufff9\011\ufff9\012\ufff9\001\002\000\014\002\ufff2\005\ufff2" +
    "\011\ufff2\012\ufff2\013\ufff2\001\002\000\004\002\000\001" +
    "\002\000\006\006\006\014\013\001\002\000\014\002\ufffd" +
    "\005\031\011\045\012\ufffd\013\044\001\002\000\006\002" +
    "\ufffb\012\ufffb\001\002\000\010\002\ufffc\011\034\012\ufffc" +
    "\001\002\000\006\006\006\014\013\001\002\000\006\006" +
    "\006\014\013\001\002\000\010\002\ufffa\011\ufffa\012\ufffa" +
    "\001\002\000\004\005\031\001\002\000\010\002\ufff7\005" +
    "\025\012\ufff7\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\046\000\016\004\011\005\003\006\007\007\010\010" +
    "\006\011\004\001\001\000\002\001\001\000\002\001\001" +
    ...
    "\001\000\006\004\011\005\032\001\001\000\010\004\011" +
    "\005\026\007\027\001\001\000\002\001\001\000\002\001" +
    "\001\000\006\004\011\005\031\001\001\000\002\001\001" +
    "\000\002\001\001\000\006\004\011\005\034\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\014" +
    "\004\011\005\040\006\042\007\010\010\041\001\001\000" +
  ...
  public final java_cup.runtime.Symbol CUP$KBParser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$KBParser$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 21: // tuple ::= tuple COMMA VARIABLE 
            {
		...
		String str = (String)((java_cup.runtime.Symbol) CUP$KBParser$stack.peek()).value;
		 t.add(SymTable.addSymbol(str, SymType.VARIABLE));RESULT=t; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 20: // tuple ::= tuple COMMA NONVAR 
            {
              Vector<Integer> RESULT =null;
		int tleft = ((java_cup.runtime.Symbol)CUP$KBParser$stack.elementAt(CUP$KBParser$top-2)).left;
		int tright = ((java_cup.runtime.Symbol)CUP$KBParser$stack.elementAt(CUP$KBParser$top-2)).right;
		...
		String str = (String)((java_cup.runtime.Symbol) CUP$KBParser$stack.peek()).value;
		 Vector<Integer> tup = new Vector<Integer>(); tup.add(SymTable.addSymbol(str, SymType.CONSTANT)); RESULT=tup; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 17: // closedTuple ::= LPAREN tuple RPAREN 
            {
              Vector<Integer> RESULT =null;
		...
		Vector<Integer> t = (Vector<Integer>)((java_cup.runtime.Symbol) CUP$KBParser$stack.elementAt(CUP$KBParser$top-1)).value;
		 RESULT=t; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 16: // basic_literal ::= NONVAR closedTuple 
            {
              Literal RESULT =null;
		...
		Vector<Integer> t = (Vector<Integer>)((java_cup.runtime.Symbol) CUP$KBParser$stack.peek()).value;
		 Literal l = new Literal(); l.setID(SymTable.addSymbol(pred, SymType.PREDICATE)); l.setNegative(false); l.setMultiParams(t); RESULT=l; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 15: // literal ::= NEG basic_literal 
            {
              Literal RESULT =null;
		...
		Literal l = (Literal)((java_cup.runtime.Symbol) CUP$KBParser$stack.peek()).value;
		 RESULT=l; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 13: // ruleSide ::= ruleSide AND literal 
            {
		...
		Literal l = (Literal)((java_cup.runtime.Symbol) CUP$KBParser$stack.peek()).value;
		 s.add(l); RESULT=s; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 12: // ruleSide ::= literal AND literal 
            {
              Vector<Literal> RESULT =null;
		...
		Literal l2 = (Literal)((java_cup.runtime.Symbol) CUP$KBParser$stack.peek()).value;
		 Vector<Literal> s = new Vector<Literal>(); s.add(l1); s.add(l2); RESULT=s; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // rule ::= ruleSide IMPLY literal 
            {
              Rule RESULT =null;
		int sleft = ((java_cup.runtime.Symbol)CUP$KBParser$stack.elementAt(CUP$KBParser$top-2)).left;
		int sright = ((java_cup.runtime.Symbol)CUP$KBParser$stack.elementAt(CUP$KBParser$top-2)).right;
		...
		Literal l = (Literal)((java_cup.runtime.Symbol) CUP$KBParser$stack.peek()).value;
		 Rule r = new Rule(s, null); r.addLeft(l); RESULT=r; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // rule ::= literal IMPLY ruleSide 
            {
              Rule RESULT =null;
		...
		int sleft = ((java_cup.runtime.Symbol)CUP$KBParser$stack.peek()).left;
		int sright = ((java_cup.runtime.Symbol)CUP$KBParser$stack.peek()).right;
		Vector<Literal> s = (Vector<Literal>)((java_cup.runtime.Symbol) CUP$KBParser$stack.peek()).value;
		 Rule r = new Rule(null, s); r.addRight(l); RESULT=r; 
          ...
          case 9: // rule ::= ruleSide IMPLY ruleSide 
            {
              Rule RESULT =null;
		int rleft = ((java_cup.runtime.Symbol)CUP$KBParser$stack.elementAt(CUP$KBParser$top-2)).left;
		int rright = ((java_cup.runtime.Symbol)CUP$KBParser$stack.elementAt(CUP$KBParser$top-2)).right;
		Vector<Literal> r = (Vector<Literal>)((java_cup.runtime.Symbol) CUP$KBParser$stack.elementAt(CUP$KBParser$top-2)).value;
		int lleft = ((java_cup.runtime.Symbol)CUP$KBParser$stack.peek()).left;
		int lright = ((java_cup.runtime.Symbol)CUP$KBParser$stack.peek()).right;
		Vector<Literal> l = (Vector<Literal>)((java_cup.runtime.Symbol) CUP$KBParser$stack.peek()).value;
